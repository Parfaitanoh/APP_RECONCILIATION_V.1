...
class OmciPayinProcessor:
    def __init__(self, data_file, partner_file, reco_start=None, reco_end=None):
        ...
        self._partner_label = "OM CI PAYIN"
...
# ================================
        ...
        # Création du tableau croisé dynamique
            ...
            maj_failed_a_succes = dfpmt.loc[(dfpmt['Statut'] != 'SUCCESS') & (dfpmt['OMCI'] == 1)]
            ...
            #recouv=service[service['Service']!='Merchant Payment']
            recouv=service[(service['Statut']=='Succès') & (service['Service']!='Merchant Payment') & (service['Service']!='Cash in')]
            st.subheader("🔴 Transactions à mettre à jour")
