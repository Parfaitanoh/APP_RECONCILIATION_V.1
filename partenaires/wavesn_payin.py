...
class WavesnPayinProcessor:
    ...
    def process(self):
        ...
        payin= dfop.loc[(dfop['Type de transaction'] == 'api_checkout') & (dfop['Nom marchand'] != 'LONASE/Click Digital Marketing') ]
...
# ================================
        ...
        with tabs[1]:
            ...
            st.subheader("Rapport Reconciliation WAVE SN PAYIN")
