...
class WavesnPayoutProcessor:
    ...
    def process(self):
        ...
        payin= dfop.loc[(dfop['Type de transaction'] == 'api_payout')& (dfop['Nom marchand'] != 'LONASE/Click Digital Marketing') ]
        ...
        correspondance_idoperator = payin.set_index('Référence client')['Identifiant de transaction']
...
# ================================
        ...
        with tabs[1]:
            ...
            st.subheader("Rapport Reconciliation WAVE SN PAYOUT")
